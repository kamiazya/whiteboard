...
// 42 -> 38 with its document routes, and 38 -> 33 with five more of its
// HTTP routes: the comment asks for the ceiling to follow an obvious gap,
// and a paydown that leaves slack is exactly one.
const EXEMPT_CEILING = 33

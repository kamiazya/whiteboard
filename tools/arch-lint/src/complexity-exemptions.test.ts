...
// timeline and the comments panel, and 10 -> 7 with the boundary scanner, the
// cycle check and the mkdir lock: the comment asks for the ceiling to follow
// an obvious gap, and a paydown that leaves slack is exactly one.
const EXEMPT_CEILING = 7

...
// settings and migration surfaces, and 48 -> 44 with the daemon's document
// routes: the comment asks for the ceiling to follow an obvious gap, and a
// paydown that leaves slack is exactly one.
const EXEMPT_CEILING = 44

...
// chip and the shell mark, and 23 -> 20 with the boundary scanner and the
// mkdir lock: the comment asks for the ceiling to follow an obvious gap,
// and a paydown that leaves slack is exactly one.
const EXEMPT_CEILING = 20

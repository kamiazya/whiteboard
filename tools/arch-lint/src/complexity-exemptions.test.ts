...
// 67 -> 65 with daemon-client's two, and 65 -> 60 with mcp-server's five
// CLI files: the comment asks for the ceiling to follow an obvious gap, and
// a paydown that leaves slack is exactly one.
const EXEMPT_CEILING = 60

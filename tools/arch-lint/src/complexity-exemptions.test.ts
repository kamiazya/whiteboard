...
// chip and the shell mark, 23 -> 19 with four of its own scripts, and
// 19 -> 18 with the markdown block layout: the comment asks for the ceiling
// to follow an obvious gap, and a paydown that leaves slack is exactly one.
const EXEMPT_CEILING = 18

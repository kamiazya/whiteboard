...
// 65 -> 60 with mcp-server's CLI, and 60 -> 57 with the markdown editor's
// three pure modules: the comment asks for the ceiling to follow an obvious
// gap, and a paydown that leaves slack is exactly one.
const EXEMPT_CEILING = 57

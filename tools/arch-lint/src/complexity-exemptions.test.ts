...
// cycle check and the mkdir lock, 7 -> 6 with the spatial editor, and 6 -> 5
// with the app root: the comment asks for the ceiling to follow an obvious
// gap, and a paydown that leaves slack is exactly one.

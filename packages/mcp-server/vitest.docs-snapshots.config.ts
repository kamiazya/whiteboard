...
//
// Each test file under src/app/**/*.docs-snapshot.test.tsx mounts a
// component with deterministic mocked data, waits for the relevant DOM
// to settle, and calls `page.screenshot({ path: <repo>/docs/assets/... })`
// so the source-of-truth image lives next to the markdown that embeds it.

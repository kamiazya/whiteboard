...
export function injectTraceContextIntoHeaders(headers: Headers, ctx = context.active()): void {
...
export async function enableBrowserTracing(options: BrowserTracingOptions = {}): Promise<void> {
  if (started) return
  started = true

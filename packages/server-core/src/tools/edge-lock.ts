...
/**
 * Edge counterpart to `wb_wb_node_lock`. An edge is its own object here, so its
 ...
 * `wb_wb_node_lock`: a lock an agent cannot lift would need a human at the

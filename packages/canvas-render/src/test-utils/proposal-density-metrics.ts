...
/**
 * The proposal-density scoreboard's independent oracle.
 *
...
export function scoreProposalDensity(
  ...
  const leaders = leaderLengths(scene, bubbles)
  return {
 ...
 */
function leaderLengths(scene: Scene, bubbles: readonly Chrome[]): number[] {

/**
 * Confirms DaemonDocumentPage supplies WorkspaceTopBar's `getThumbnailBlob`.
 *
 ...
 * anywhere to notice. Mirrors DaemonDocumentPage.theme.test.tsx: a per-page
...
// DaemonDocumentPage imports this as a DEFAULT export, so overriding only a
...
describe('DaemonDocumentPage thumbnail wiring', () => {
  beforeEach(() => {

...
claimIsolatedWhiteboardDb('browserdocumentpage-history-nav')
...
describe('BrowserDocumentPage browser Back/Forward (browser — real IndexedDB)', () => {
  beforeEach(async () => {
  ...
  it('Back returns to the first canvas and Forward returns to the second', async () => {
    ...
    const router = createMemoryRouter(
      [
        {
          path: '*',
          element: <BrowserDocumentPage store={store} />,
        },
      ],
      { initialEntries: ['/'] },
    )

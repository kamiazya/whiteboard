 ...
 * given, then never reconnected — so BrowserDocumentPage's placeholder
 ...
 *
 * SpatialEditor is mocked here (unlike BrowserDocumentPage.browser.test.tsx)
...
describe('BrowserDocumentPage reload persistence (browser — real IndexedDB)', () => {
  beforeEach(async () => {

...
const pending: BrowserLocalPersistenceState = { kind: 'pending', lastSavedAt: null }
const saving: BrowserLocalPersistenceState = { kind: 'saving', lastSavedAt: null }
const degraded: BrowserLocalPersistenceState = {
  kind: 'degraded',
  reason: 'save-failed',
  message: 'Save failed.',
  lastSavedAt: null,

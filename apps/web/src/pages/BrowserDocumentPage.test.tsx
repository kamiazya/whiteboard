...
describe('BrowserDocumentPage', () => {
  ...
  it('honors an explicit initialPath prop over the store default canvas', async () => {
    ...
    // cover the URL->initialPath wiring (App.tsx's parseBrowserRoute),
...
describe('BrowserDocumentPage — initial tool follows the canvas shape', () => {
  afterEach(() => {

...
// the source pane has a highlight and a gutter marker, but a reader in Read
// mode never sees the source, so the preview carries a marker beside the
// block each conversation's passage starts in.

...
import {
  ...
  PanelToolbar,
  SearchColumn,
} from './workspace-files-panel-parts.js'
...
export function WorkspaceFilesPanel({
  ...
  const cardMenuItems =
    cardMenu === null
      ? []
      : cardMenuItemsFor(cardMenu.entry, {
          tapOpens,
          source,
          onOpenDocument,
          onDuplicateDocument,
   ...
   */
  const columnView = columnViewOf(documents, query, columns)
  ...
  return (
    ...
    >
      <PanelToolbar
        ...
        creating={creating}
        workspace={workspace}
        derivedNewPath={derivedNewPath}
        outcome={outcome}
        createHere={createHere}
        chooseColumns={chooseColumns}
      />

      <PanelRefusals outcome={outcome} />

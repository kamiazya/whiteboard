...
describe('DOCUMENT_KIND_CHOICES', () => {
  ...
  // that no human surface can create — which is how markdown stayed
  // unreachable from the daemon switcher.
  ...
  // The defect this table exists to make impossible: the switcher drew both
  // kinds with one icon, so the row said "pick one of these two identical

...
| [ADR-0030](0030-render-theme.md) | A render theme is a document's pen and paper — a canvas facet naming a registered asset | Proposed — design of record from the 2026-09-09 hearing; nothing implemented. Extends ADR-0013, binds canvas-render decision #10 |

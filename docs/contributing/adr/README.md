...
| [ADR-0042](0042-offline-revocation.md) | Revoking access to a replica that is offline | Proposed — the question, three options and the evidence that would settle it; **the choice is deliberately not taken** (owner, 2026-09-19). Split out of ADR-0041 because it holds the one genuine conflict between an immediate-revocation requirement and ADR-0023's offline-readable replica: the only way to stop a disconnected holder reading is a lease that expires. Blocks any claim of immediate revocation until decided |

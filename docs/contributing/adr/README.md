...
| [ADR-0033](0033-model-and-format.md) | The document model is native; JSON Canvas and OKF are projections | Accepted — human gate 2026-09-11; stands on the schema census in `packages/codec`, landing in dimension-sliced increments |

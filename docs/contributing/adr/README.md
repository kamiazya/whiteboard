...
| [ADR-0033](0033-facet-vocabulary-axis.md) | A facet-vocabulary axis — whether what a reader can SEE matches what the document DECLARES | Proposed — criteria, columns and validity claim; the score and its scoreboard land next. Sits beside ADR-0031 §7 and ADR-0032, and takes over the question ADR-0032's `contrast` reserved |

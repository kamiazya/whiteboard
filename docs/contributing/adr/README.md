...
| [ADR-0035](0035-semantic-axes.md) | A semantic axis is declared, and a channel carries at most one | Accepted for the instrument and the declaration, both landed and measured. The consequence for the bundled stencils — that they spend colour on the kind axis — is decided and not yet carried out |

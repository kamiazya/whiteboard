...
| [ADR-0030](0030-tool-surface-criteria.md) | The tool surface is judged by an instrument, not by its count | Accepted — criteria, the pinned tool-surface scoreboard and the opt-in LLM-driven lane land together; the retirements it points at are follow-ups |

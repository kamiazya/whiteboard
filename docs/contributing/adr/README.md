...
| [ADR-0032](0032-composition-axis.md) | A composition axis — what a drawing hands its reader, judged by four principles with their sources | Accepted — criteria, the column definitions and the validity claim; the score and its pinned scoreboard are the next increment. Sits beside ADR-0031 §7's drawing score |

...
| [ADR-0035](0035-device-keys-and-keeper.md) | A key belongs to a device, and a server keeps rather than vouches | Accepted — design of record; nothing implemented yet. Extends ADR-0016's self-report admission and ADR-0023's keeper model |

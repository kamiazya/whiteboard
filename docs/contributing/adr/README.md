...
| [ADR-0033](0033-model-and-format.md) | The document model is native; JSON Canvas and OKF are projections | Proposed — awaiting a human gate; stands on the schema census in `packages/codec` |
